...
function positionBalloonAndRobbyContainerHorizontally() {
    var e = pageVerticalPosition * layerHorizontalSpeedArray[layerHorizontalSpeedArray.length - 1] - (layerHorizontalArray[layerHorizontalArray.length - 1].offsetWidth - containerDiv.offsetWidth), t = 250, i = 50;
    ...
    var a = .5 * containerDiv.offsetWidth + i, o = .5 * (containerDiv.offsetWidth - balloonDiv.offsetWidth) + e;
...
function orientRobby() {
    deltaPageVerticalPosition > 0 && (robbyFramesDiv.style.top = "0px", robbyEyesCloseDiv.style.left = "80px"), 0 > deltaPageVerticalPosition && (robbyFramesDiv.style.top = "-200px", robbyEyesCloseDiv.style.left = "55px")
}
function storeDivs() {
...
function nbaBoardsFall() {
    ...
    }), nbaBoardsCounter += 1, nbaBoardsCounter >= nbaBoardArray.length && (nbaBoardsCounter = 0)
}
...
function bounceBall() {
    $(nbaBallDiv).fadeTo(0, 1), $(nbaBallDiv).stop().animate({bottom: [0, "easeOutBounce"]}, 1200, function () {
    })
}
...
function animateRobot() {
    $(robotDiv).stop().animate({left: "380px"}, 1e3, function () {
...
function animateAlien() {
    $(alienDiv).stop().animate({left: "540px"}, 1e3, function () {
        animatePiechartFoxnewsFront(), animateAlienHand()
    })
}
function animatePiechartIncognitoFront() {
    "internet explorer" == browserName && browserVersion <= 8 ? animatePiechartIncognitoText() : $(piechartIncognitoFrontDiv).stop().animate({opacity: 1}, 500, function () {
        animatePiechartIncognitoText()
    })
}
function animatePiechartFoxnewsFront() {
    "internet explorer" == browserName && browserVersion <= 8 ? animatePiechartFoxnewsText() : $(piechartFoxnewsFrontDiv).stop().animate({opacity: 1}, 500, function () {
...
function animatePiechartAolTextGraphic() {
    $(piechartAolTextGraphic1Div).stop().animate({opacity: 1}, 1e3, function () {
    }), $(piechartAolTextGraphic2Div).stop().animate({opacity: 1}, 1e3, function () {
    })
}
...
function animatePiechartIncognitoTextCode() {
    $(piechartIncognitoTextCode1Div).stop().animate({opacity: 1}, 1e3, function () {
    }), $(piechartIncognitoTextCode2Div).stop().animate({opacity: 1}, 1e3, function () {
    })
}
function animatePiechartIncognitoTextGraphic() {
    $(piechartIncognitoTextGraphic1Div).stop().delay(300).animate({opacity: 1}, 1e3, function () {
    }), $(piechartIncognitoTextGraphic2Div).stop().delay(300).animate({opacity: 1}, 1e3, function () {
    })
}
function animatePiechartIncognitoTextAnimation() {
    $(piechartIncognitoTextAnimation1Div).stop().delay(600).animate({opacity: 1}, 1e3, function () {
    }), $(piechartIncognitoTextAnimation2Div).stop().delay(600).animate({opacity: 1}, 1e3, function () {
    })
}
...
function animatePiechartFoxnewsTextCode() {
    $(piechartFoxnewsTextCode1Div).stop().animate({opacity: 1}, 1e3, function () {
    }), $(piechartFoxnewsTextCode2Div).stop().animate({opacity: 1}, 1e3, function () {
    })
}
function animatePiechartFoxnewsTextAnimation() {
    $(piechartFoxnewsTextAnimation1Div).stop().delay(300).animate({opacity: 1}, 1e3, function () {
    }), $(piechartFoxnewsTextAnimation2Div).stop().delay(300).animate({opacity: 1}, 1e3, function () {
    })
}
function animatePiechartFoxnewsTextGraphic() {
    $(piechartFoxnewsTextGraphic1Div).stop().delay(600).animate({opacity: 1}, 1e3, function () {
    }), $(piechartFoxnewsTextGraphic2Div).stop().delay(600).animate({opacity: 1}, 1e3, function () {
    })
}
...
function blinkSeaAnimals(e) {
    ...
    for (var a = 0; a < i.length; a++)$(i[a]).fadeTo(0, 1), $(i[a]).stop().delay(300).animate({opacity: 0}, 0, function () {
    })
}
...
var contentDiv = document.getElementById("content"), pageDiv = document.getElementById("page"), robbyContainerDiv = document.getElementById("robby-container"), robbyDiv = document.getElementById("robby"), robbyFramesDiv = document.getElementById("robby-slides"), robbyEyesCloseDiv = document.getElementById("robby-eyes-close"), blinkRobbyEyesTimer, bannersContainerDiv = document.getElementById("banners-container"), isPreloadShiftUpAnimationFinish = !1, canFinishShiftUpHorizontalLayersAfterEverythingLoaded = !0, splashContainerDiv = document.getElementById("splash-container"), balloonDiv = document.getElementById("balloon"), groundAndGrassContainer1Div = document.getElementById("ground-and-grass-container-1"), elevation1Div = document.getElementById("elevation-1"), elevation2Div = document.getElementById("elevation-2"), layerHorizontalArray = new Array, layerVerticalArray = new Array, gapBetweenContactCloudAndBannersContainer = 400, layerHorizontalSpeedArray = new Array, layerVerticalSpeedArray = new Array, sea1Div = document.getElementById("sea-1"), seaFloorDiv = document.getElementById("sea-floor"), seaFloorFrontObjectArray = new Array, seaFloorBackObjectArray = new Array, about1ContainerDiv = document.getElementById("plants-container"), plantLine1Div = document.getElementById("plant-line-1"), plantLine2Div = document.getElementById("plant-line-2"),plantLine3Div = document.getElementById("plant-line-3"),plantLine4Div = document.getElementById("plant-line-4"), plantArray = new Array, plantTargetTopObjectArray = new Array;
plantTargetTopObjectArray.push(plantLine3Div, plantLine4Div, plantLine4Div, plantLine4Div);
...
var buildingLegArray = new Array, canAnimateBuildingInformation, buildingCounter = 0, buildingLegsTimer, buildingBlinkTimer, buildingEnemyFaceEyeArray = new Array, buildingLegContainerArray = new Array, buildingLegContainer1Div = document.getElementById("building-leg-container-1"), buildingLegContainer2Div = document.getElementById("building-leg-container-2"), buildingLegContainer3Div = document.getElementById("building-leg-container-3"), buildingLegFrameArray = new Array, building1LegFrameDiv = document.getElementById("building-1-leg-frame"), building2LegFrameDiv = document.getElementById("building-2-leg-frame"), building3LegFrameDiv = document.getElementById("building-3-leg-frame"), experience1ContainerDiv = document.getElementById("experience-1-container"), experience2ContainerDiv = document.getElementById("experience-2-container"), experience3ContainerDiv = document.getElementById("experience-3-container"), experienceTextContainerArray = new Array, chainBlockAndStringContainerArray = new Array, experienceTextContainerDistanceFromFloor = 185, robotDiv = document.getElementById("robot"), animateRobotHandsTimer, spinRobotHandsTimer, changeRobotHandsCounter = 0, robotHandLeftDiv = document.getElementById("robot-hand-left"), robotHandRightDiv = document.getElementById("robot-hand-right"), robotHandChildrenLength = $(robotHandLeftDiv).children().length, squidDiv = document.getElementById("squid"), squidHandCloseArray = new Array, squidHandOpenArray = new Array, animateSquidHandsTimer, moveSquidHandsTimer, openAndCloseSquidHandsCounter = 0, alienDiv = document.getElementById("alien"), animateAlienHandsTimer, alienSteerDiv = document.getElementById("alien-steer"), alienSteerAngle = 0, alienSteerPreviousAngle, alienSteerAngleLimit = 15, alienSteerAngleIncrement = 5, canAnimateBossInformation, canAnimateRobotInformation, canAnimateSquidInformation, canAnimateAlienInformation, piechartAolTextGraphic1Div = document.getElementById("piechart-aol-text-graphic-1"), piechartAolTextGraphic2Div = document.getElementById("piechart-aol-text-graphic-2"), piechartIncognitoFrontDiv = document.getElementById("piechart-incognito-front"), piechartIncognitoTextGraphic1Div = document.getElementById("piechart-incognito-text-graphic-1"), piechartIncognitoTextGraphic2Div = document.getElementById("piechart-incognito-text-graphic-2"), piechartIncognitoTextAnimation1Div = document.getElementById("piechart-incognito-text-animation-1"), piechartIncognitoTextAnimation2Div = document.getElementById("piechart-incognito-text-animation-2"), piechartIncognitoTextCode1Div = document.getElementById("piechart-incognito-text-code-1"), piechartIncognitoTextCode2Div = document.getElementById("piechart-incognito-text-code-2"), piechartFoxnewsFrontDiv = document.getElementById("piechart-foxnews-front"), piechartFoxnewsTextGraphic1Div = document.getElementById("piechart-foxnews-text-graphic-1"), piechartFoxnewsTextGraphic2Div = document.getElementById("piechart-foxnews-text-graphic-2"), piechartFoxnewsTextAnimation1Div = document.getElementById("piechart-foxnews-text-animation-1"), piechartFoxnewsTextAnimation2Div = document.getElementById("piechart-foxnews-text-animation-2"), piechartFoxnewsTextCode1Div = document.getElementById("piechart-foxnews-text-code-1"), piechartFoxnewsTextCode2Div = document.getElementById("piechart-foxnews-text-code-2"), bubbleDiv = document.getElementById("bubble"), bubbleTimer, shiftUpLayerHorizontalDistance, shiftUpLayerHorizontalTimer, shiftDownLayerHorizontalTimer, shiftUpDownLayerHorizontalIncrement = 40, shiftUpDownLayerHorizontalInterval = 40, seaAnimalSwimDistance = 900, blinkSeaAnimalsTimer, skill1ContainerDiv = document.getElementById("skill-1-container"), fishArray = new Array, fishEyeArray = new Array, canAnimateFishInformation, isFishStillAnimating = !1, fishAnimateNumber = 0, numberOfFishInEachRowArray = new Array;
numberOfFishInEachRowArray.push(2, 2, 2, 2);
var skill2ContainerDiv = document.getElementById("skill-2-container"), crabArray = new Array, crabEyeArray = new Array, canAnimateCrabInformation, isCrabStillAnimating = !1, crabAnimateNumber = 0, numberOfCrabInEachRowArray = new Array;
numberOfCrabInEachRowArray.push(2, 2, 2, 2);
var skill3ContainerDiv = document.getElementById("skill-3-container"), turtleArray = new Array, turtleEyeArray = new Array, canAnimateTurtleInformation, isTurtleStillAnimating = !1, turtleAnimateNumber = 0, numberOfTurtleInEachRowArray = new Array;
numberOfTurtleInEachRowArray.push(2, 2, 2, 2);
var pageVerticalPosition = 0, pageVerticalPositionOnTouch = 0, previousPageVerticalPosition = 0, deltaPageVerticalPosition = 0, isRobbySwimming = !1, isRobbyJumping, isRobbyFalling, isRobbyBelowSeaLevel = !1, swimUpHeight, layersMovement, elevationArray = new Array, elevationNumberBelowRobby = null, robbyRightEdge, robbyLeftEdge, distanceBetweenRobbyAndBalloon = 150, robbyMaxHorizontalDistance, counter = 0, switcher = 1, robbyStaticFrame = 0, robbyStartRunFrame = 1, robbyStopRunFrame = 2, robbyStartSwimFrame = 3, robbyStopSwimFrame = 4, robbySwimDownFrame = 5, robbyStartJumpFrame = 6, robbyStopJumpFrame = 7, robbyOneFrameWidth = 200, shiftRobbyFrameTimeInterval = 200, canAnimateRobbyRunSwim, robbyStartFrame, robbyStopFrame, shiftRobbyFrameTimer, pageVerticalPositionWhenAnimateRobby1, pageVerticalPositionWhenAnimateRobby2, minimumVerticalDistanceToTriggerRobbySwimDownFrame = 100, nbaBoardArray = new Array, about3ContainerDiv = document.getElementById("nba-container"), nbaPlayerDiv = document.getElementById("nba-player"), nbaPlayerContainerDiv = document.getElementById("nba-player-container"), nbaPlayerFrameDiv = document.getElementById("nba-player-frame"), nbaRimContainerDiv = document.getElementById("nba-rim-container"), nbaBallDiv = document.getElementById("nba-ball"), canAnimateNbaInformation, nbaBoardsCounter, nbaBoardsAnimationTimer, nbaPlayerCounter, nbaPlayerTimer, nbaPlayerEyesDiv = document.getElementById("nba-player-eyes"), blinkNbaPlayerTimer, contactContainerDiv = document.getElementById("contact-container"), socialContainerDiv = document.getElementById("social-container"), canAnimateSocialContainer, happyRobbyTimer, isRobbyHappy = !1, scrollOrSwipeTextContainer1Div = document.getElementById("scroll-or-swipe-text-container-1"), scrollOrSwipeTextContainer2Div = document.getElementById("scroll-or-swipe-text-container-2"), canHideScrollOrSwipeTextContainer = !0, scrollOrSwipeTextContainerTimer, canAnimateScrollOrSwipeTextContainer = !0, contactConfirmationContainerArray = new Array, emailAddressDiv = document.getElementById("email-address"), emailSubjectDiv = document.getElementById("email-subject"), emailMessageDiv = document.getElementById("email-message"), isContactConfirmationContainerVisible = !0, waterfall1Div = document.getElementById("waterfall-1"), waterfall2Div = document.getElementById("waterfall-2"), waterfallTimer, touchStartX = 0, touchCurrentX = 0, touchEndX = 0, fireworksContainerDiv = document.getElementById("fireworks-container"), fireworkArray = new Array, fireworkSvgArray = new Array, cArray = new Array, drawFireworkTimer, drawFireworkCounter = 0, fireworkRowNumber = 8, fireworkColumnNumber = 16, fireworkLayerNumber = 0, fireworkDotRadius = 5, fireworkCenterX, fireworkCenterY, fireworkOneRadiusDistance, fireworkOneRotationAngle, drawOneLayerOfFireworkTimer, canDrawManyFireworks = !0;
